...
const YourSnippets: React.FC = () => {
  ...
  return (
    <div className="bg-gray-900 text-white min-h-screen pt-20 px-4 sm:px-6 lg:px-8">
      {/* Snippets Grid */}
        ...
        {snippets.length === 0 && (
          <div className="text-center text-white space-y-4">
            ...
            <p className="text-gray-400 text-lg">
              Looks like you haven't added any snippets yet. Add your first one
              below!
            </p>
            <button
              onClick={() => navigate("/addSnippet")}
              className="px-6 py-3 bg-indigo-600 rounded-md text-white text-lg hover:bg-indigo-700 transition duration-200"
            >
              Add Snippet
            </button>
          </div>
